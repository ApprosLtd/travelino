...
<section class="flymenu covert light">
  <nav>
    <ul>
      <li>{{#link-to 'places'}}<span>Места</span>{{/link-to}}</li>
      <li>{{#link-to 'airports'}}<span>Авиабилеты</span>{{/link-to}}</li>
      <li>{{#link-to 'hotels'}}<span>Гостиницы</span>{{/link-to}}</li>
      <li>{{#link-to 'tours'}}<span>Туры</span>{{/link-to}}</li>
      <li>{{#link-to 'trails'}}<span>Маршруты</span>{{/link-to}}</li>
    </ul>
  </nav>
</section>
